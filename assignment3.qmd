...
Almond func: - The entire almond yield for that year

Profit func: - Compute profit given yearly almond yield (pa)

profit_almond \<- compute_profit_fromyield( almond_yield = clean_monthly$almond_yield, # input
  year = clean_monthly$year, \# input price = 30, \# idk (parameter?) discount = 0.04 \# parameter )
...
You could also do it in another way: - One graph with almond yields in any one year or for all years together, with uncertainty - One graph with profits over time with uncertainty
